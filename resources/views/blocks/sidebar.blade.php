<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item @if(strpos(Route::currentRouteName(), 'admin.templates.index') !== false) active @endif">
            <a href="{{ route('admin.templates.index') }}" class="menu-link">
                <i class="menu-icon tf-icons ti ti-messages"></i>
                <div >Шаблоны</div>
            </a>
        </li>
        <li class="menu-item @if(strpos(Route::currentRouteName(), 'admin.orders.index') !== false) active @endif">
        ...
        <li class="menu-item @if(str_contains(Route::currentRouteName(), 'admin.accounts.index')) active @endif">
        ...
        <li class="menu-item @if(str_contains(Route::currentRouteName(),'admin.chat.index')) active @endif">
        ...
        <li class="menu-item @if(str_contains(Route::currentRouteName(), 'admin.settings.index')) active @endif">
